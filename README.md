...
$c(t)=0.5+0.2\sin(t), \qquad e(t)=0.6+0.1\cos(t),$
...
$p(0) = 0.65, 0.50, 0.35, 0.20.$

### Figure 4 — Periodic solutions

For the periodic example,

$c(t)=0.5+0.1\sin(t), \qquad e(t)=0.7+0.1\cos(t),$
...
$K(p,\alpha)= \begin{cases} 0, & p<p_{\min},\[2mm] \displaystyle \alpha\frac{1-p}{2-(p+p_{\min})}, & p\geq p_{\min}.\end{cases}$
...
$t_k=3k,\qquad t_k=2k,\qquad t_k=k.$
